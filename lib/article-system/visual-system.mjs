...
const TRANSPARENT_BACKGROUND_PROMPT = `Isolated illustration on a fully transparent background. Preserve clean transparent padding around every object. No white, colored, gradient, scene, room, floor, shadow-plane, or rectangular background.`;
