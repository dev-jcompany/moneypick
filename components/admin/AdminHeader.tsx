...
export default function AdminHeader() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-20 items-center justify-between border-b border-[#E4EAE7] bg-white/95 px-5 pl-20 backdrop-blur lg:px-8">
      ...
      <div className="flex items-center gap-3"><AdminLogoutButton /><div className="hidden text-right sm:block"><strong className="block text-sm">머니픽 관리자</strong><span className="text-xs text-slate-500">최고 관리자</span></div><span className="flex h-10 w-10 items-center justify-center rounded-full bg-green-100 font-bold text-[#17794A]">관</span></div>
    </header>
  );
}
